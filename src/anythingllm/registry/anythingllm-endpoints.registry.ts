...
export const AnythingLLMAdminEndpointIds = {
  ...
  UPDATE_WORKSPACE_EMBEDDINGS: 'admin.updateWorkspaceEmbeddings',
  UPDATE_WORKSPACE_PIN: 'admin.updateWorkspacePin',
  CREATE_WORKSPACE: 'admin.createWorkspace',
  LIST_WORKSPACES: 'admin.listWorkspaces',
  GET_WORKSPACE: 'admin.getWorkspace',
  UPDATE_WORKSPACE: 'admin.updateWorkspace',
  DELETE_WORKSPACE: 'admin.deleteWorkspace',
  CREATE_THREAD: 'admin.createThread',
  UPDATE_THREAD: 'admin.updateThread',
  DELETE_THREAD: 'admin.deleteThread',
  GET_THREAD_CHATS: 'admin.getThreadChats',
  THREAD_CHAT: 'admin.threadChat',
  VECTOR_SEARCH: 'admin.vectorSearch',
  OPENAI_CHAT_COMPLETIONS: 'admin.openaiChatCompletions',
  OPENAI_EMBEDDINGS: 'admin.openaiEmbeddings',
} as const;
...
> = {
  ...
  [AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE_EMBEDDINGS]: {
    id: AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE_EMBEDDINGS,
    method: 'POST',
    path: '/v1/admin/workspaces/:workspaceSlug/update-embeddings',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: ManageWorkspaceUsersResponseSchema,
    tags: ['admin', 'workspaces'],
  ...
  [AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE_PIN]: {
    id: AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE_PIN,
    method: 'POST',
    path: '/v1/admin/workspaces/:workspaceSlug/pin',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: ManageWorkspaceUsersResponseSchema,
    tags: ['admin', 'workspaces'],
  ...
  [AnythingLLMAdminEndpointIds.CREATE_WORKSPACE]: {
    id: AnythingLLMAdminEndpointIds.CREATE_WORKSPACE,
    method: 'POST',
    path: '/v1/admin/workspaces/new',
    auth: 'serviceIdentity',
  ...
  [AnythingLLMAdminEndpointIds.LIST_WORKSPACES]: {
    id: AnythingLLMAdminEndpointIds.LIST_WORKSPACES,
    method: 'GET',
  ...
  [AnythingLLMAdminEndpointIds.GET_WORKSPACE]: {
    id: AnythingLLMAdminEndpointIds.GET_WORKSPACE,
    method: 'GET',
    path: '/v1/admin/workspaces/:slug',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: CreateWorkspaceResponseSchema,
    tags: ['admin', 'workspaces'],
  ...
  [AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE]: {
    id: AnythingLLMAdminEndpointIds.UPDATE_WORKSPACE,
    method: 'POST',
    path: '/v1/admin/workspaces/:slug/update',
    auth: 'serviceIdentity',
    requestSchema: CreateWorkspaceRequestSchema,
    responseSchema: CreateWorkspaceResponseSchema,
    tags: ['admin', 'workspaces'],
  ...
  [AnythingLLMAdminEndpointIds.DELETE_WORKSPACE]: {
    id: AnythingLLMAdminEndpointIds.DELETE_WORKSPACE,
    method: 'DELETE',
    path: '/v1/admin/workspaces/:slug',
    auth: 'serviceIdentity',
    requestSchema: null,
  ...
  [AnythingLLMAdminEndpointIds.CREATE_THREAD]: {
    id: AnythingLLMAdminEndpointIds.CREATE_THREAD,
    method: 'POST',
  ...
  [AnythingLLMAdminEndpointIds.UPDATE_THREAD]: {
    id: AnythingLLMAdminEndpointIds.UPDATE_THREAD,
    method: 'POST',
    path: '/v1/workspace/:slug/thread/:threadSlug/update',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: null as any,
    tags: ['admin', 'threads'],
  ...
  [AnythingLLMAdminEndpointIds.DELETE_THREAD]: {
    id: AnythingLLMAdminEndpointIds.DELETE_THREAD,
    method: 'DELETE',
    path: '/v1/workspace/:slug/thread/:threadSlug',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: null as any,
    tags: ['admin', 'threads'],
  ...
  [AnythingLLMAdminEndpointIds.GET_THREAD_CHATS]: {
    id: AnythingLLMAdminEndpointIds.GET_THREAD_CHATS,
    method: 'GET',
    path: '/v1/workspace/:slug/thread/:threadSlug/chats',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: null as any,
    tags: ['admin', 'threads'],
  ...
  [AnythingLLMAdminEndpointIds.THREAD_CHAT]: {
    id: AnythingLLMAdminEndpointIds.THREAD_CHAT,
    method: 'POST',
    path: '/v1/workspace/:slug/thread/:threadSlug/chat',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: null as any,
    tags: ['admin', 'threads'],
    timeoutMs: 60000, // Longer timeout for chat
  },

  [AnythingLLMAdminEndpointIds.VECTOR_SEARCH]: {
    id: AnythingLLMAdminEndpointIds.VECTOR_SEARCH,
    method: 'POST',
    path: '/v1/system/vector-search',
    auth: 'serviceIdentity',
    requestSchema: null,
    responseSchema: null as any,
    tags: ['admin', 'system'],
  ...
  [AnythingLLMAdminEndpointIds.OPENAI_CHAT_COMPLETIONS]: {
    id: AnythingLLMAdminEndpointIds.OPENAI_CHAT_COMPLETIONS,
    method: 'POST',
  ...
  [AnythingLLMAdminEndpointIds.OPENAI_EMBEDDINGS]: {
    id: AnythingLLMAdminEndpointIds.OPENAI_EMBEDDINGS,
    method: 'POST',
