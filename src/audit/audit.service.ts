...
export enum AuthEventType {
  ...
  ANYTHINGLLM_WORKSPACE_CREATION_STARTED = 'ANYTHINGLLM_WORKSPACE_CREATION_STARTED',
  ANYTHINGLLM_WORKSPACE_CREATION_SUCCEEDED = 'ANYTHINGLLM_WORKSPACE_CREATION_SUCCEEDED',
  ANYTHINGLLM_WORKSPACE_CREATION_FAILED = 'ANYTHINGLLM_WORKSPACE_CREATION_FAILED',
  ANYTHINGLLM_WORKSPACE_ASSIGNMENT_VERIFIED = 'ANYTHINGLLM_WORKSPACE_ASSIGNMENT_VERIFIED',
