...
POST   /api/anythingllm/admin/users/:id
DELETE /api/anythingllm/admin/users/:id
GET    /api/anythingllm/admin/invites
POST   /api/anythingllm/admin/invite/new
DELETE /api/anythingllm/admin/invite/:id
GET    /api/anythingllm/admin/workspaces/:workspaceId/users
POST   /api/anythingllm/admin/workspaces/:workspaceSlug/manage-users
