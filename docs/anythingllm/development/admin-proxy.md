...
|----------|--------|------|
| Multi-user mode check | GET | `/api/anythingllm/v1/admin/is-multi-user-mode` |
| List users | GET | `/api/anythingllm/v1/admin/users` |
| Create user | POST | `/api/anythingllm/v1/admin/users/new` |
| Update user | POST | `/api/anythingllm/v1/admin/users/:id` |
| Delete user | DELETE | `/api/anythingllm/v1/admin/users/:id` |
| List invites | GET | `/api/anythingllm/v1/admin/invites` |
| Create invite | POST | `/api/anythingllm/v1/admin/invite/new` |
| Revoke invite | DELETE | `/api/anythingllm/v1/admin/invite/:id` |
| Get workspace users | GET | `/api/anythingllm/v1/admin/workspaces/:id/users` |
| Manage workspace users | POST | `/api/anythingllm/v1/admin/workspaces/:slug/manage-users` |
| Workspace chats | POST | `/api/anythingllm/v1/admin/workspace-chats` |
| Update preferences | POST | `/api/anythingllm/v1/admin/preferences` |
